...
fig, axes = plt.subplots(4, 3, figsize=(12.5, 15.5), squeeze=False)
...
fig.suptitle("EXPERT autonomous speed |F| (log) · cyan = slow set |F|<0.05 · lime = mean A-nogo path cue-on→test-on\n"
             "columns: cue 0 / 1 / 2 (same DPA start per row-seed)", fontsize=11)
fig.tight_layout()
out = "/home/leon/rnn/results/figures/sweep_r2cue2/slow_manifold_dose"
